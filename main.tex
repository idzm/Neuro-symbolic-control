...
\usetikzlibrary{quotes, positioning, arrows.meta, arrows, calc, shapes,
  patterns}
...
\usepackage[mode=buildnew]{standalone} % Load standalone with incremental
                                       % build (shell-escape required).
                                       % Note: pdflatex must be run with
                                       % -shell-escape for this to work.
