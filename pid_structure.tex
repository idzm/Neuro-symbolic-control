\begin{tikzpicture}[ auto, node distance=1.5cm, >=Latex,
    ...
    block/.style={ draw, fill=white, rectangle, minimum height=0.9cm, minimum
        width=2.4cm, align=center, inner xsep=3pt, font=\small },
    process_block/.style={ block, minimum width=1.6cm },
